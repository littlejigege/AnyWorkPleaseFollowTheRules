...
//    Button cancel;
    ...
    private NewBaseDialog(Builder builder1) {
        super(builder1.context);
        builder = builder1;
    }

    private NewBaseDialog(Builder builder1, @StyleRes int themeResId) {
...
//        }
        ...
        public NewBaseDialog build() {
            NewBaseDialog baseDialog;
            if (resStyle != -1) {
                baseDialog =  new NewBaseDialog(this, resStyle);
            } else {
                baseDialog =  new NewBaseDialog(this, R.style.AnyWork_Theme_Dialog);
            }
